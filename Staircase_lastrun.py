...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP\\OneDrive\\Desktop\\PyshoPy\\Staircase exp\\Staircase_lastrun.py',
...
grating = visual.GratingStim(
    ...
    ori=0.0, pos=[0,0], size=(0.1,0.1), sf=1.0, phase=0.0,
...
conditions = data.importConditions('Staircase Conditions.xlsx')
...
for level, condition in trials:
    ...
    trialComponents = [ISI, polygon, grating, key_resp]
