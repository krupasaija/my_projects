...
expName = 'Sequence learning'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP\\OneDrive\\Desktop\\PsychoPy\\Sequence Learning\\Sequence learning_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/HP/OneDrive/Desktop/sequence learning.csv'),
